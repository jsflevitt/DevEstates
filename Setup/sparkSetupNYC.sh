...
installSpark () {
	...
	ssh -i "<key-path>" ubuntu@$ipAddress \
		...
		wget -nv https://repo1.maven.org/maven2/org/apache/poi/poi/4.1.2/poi-4.1.2.jar;
		wget -nv https://repo1.maven.org/maven2/org/apache/poi/poi-ooxml/4.1.2/poi-ooxml-4.1.2.jar;
		wget -nv https://repo1.maven.org/maven2/org/apache/poi/poi-ooxml-schemas/4.1.2/poi-ooxml-schemas-4.1.2.jar;
		wget -nv https://repo1.maven.org/maven2/org/apache/xmlbeans/xmlbeans/3.1.0/xmlbeans-3.1.0.jar;
		...
		sudo mv ~/spark-excel_2.11-0.13.1.jar /usr/local/spark/jars/;
		sudo mv ~/poi-4.1.2.jar /usr/local/spark/jars/;
		sudo mv ~/poi-ooxml-4.1.2.jar /usr/local/spark/jars/;
		sudo mv ~/poi-ooxml-schemas-4.1.2.jar /usr/local/spark/jars/;
		sudo mv ~/xmlbeans-3.1.0.jar /usr/local/spark/jars/;
		exit
		"
}
